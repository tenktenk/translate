...
Project, Version 1 (GRUMPv1): Population Count Grid data product.  
Documentation is available on the GRUMP web site at:
http://sedac.ciesin.columbia.edu/data/dataset/grump-v1-population-count/docs
...
Available at http://sedac.ciesin.columbia.edu/data/dataset/grump-v1-population-count. 
(Date of download).


DATA FORMAT

This archive contains the population for 2000, 1995, 1990 in ESRI raster (GRID), 
...
upxxg		population counts in year xx*, unadjusted
upxxag		population counts in year xx*, adjusted to match UN country totals
...
*xx is the year of the population counts -- 1990, 1995, and 2000 are
represented as 90, 95, and 00, respectively. The file names are prefixed
...
ATTRIBUTE FIELDS
     ...
     VALUE	population count in the grid cell.
